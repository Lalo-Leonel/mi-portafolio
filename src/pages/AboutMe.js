      ...
      <div className="flex flex-row gap-5 justify-center items-center">
        <div>
          ...
          <div className=" flex flex-row gap-3">
            <Icon url="https://github.com/Lalo-Leonel">
              <svg
                height={30}
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
                data-icon="github"
                class="svg-inline--fa fa-github fa-w-16 social_icon"
                role="img"
            ...
            <Icon>
              <svg
                ...
                data-prefix="fab"
                data-icon="linkedin"
                class="svg-inline--fa fa-linkedin fa-w-14 social_icon"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
            ...
            <Icon url="https://api.whatsapp.com/send?phone=51958382023">
              <svg
                height={30}
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
                data-icon="whatsapp"
                class="svg-inline--fa fa-whatsapp fa-w-14 social_icon"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
            ...
            <a href="tel:+51958382023" className="text-white">(+51)958382023</a>
          </div>
        </div>
